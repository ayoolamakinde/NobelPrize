...
public class bioFragment extends Fragment {
    ...
    public void setDetails(int value, int bonus) {
        ...
        if (value == 3) {
            ...
            if (bonus == 1) {
                ...
                //imageNobel2.setImageResource(R.drawable.peace);
            } else {
                imageNobel.setImageResource(R.drawable.peace);
    ...
    //  Button quit = (Button) getActivity().findViewById(R.id.normalButton);
